...
Plans:
- [x] 09-01-PLAN.md — Post creation: rewire usePostForm + PostFormFields + CreatePostModal to presigned URL upload via api/community.ts
- [x] 09-02-PLAN.md — Feed page + FeedItem: infinite scroll pagination, optimistic like, comment CRUD with permission delete, post delete
- [x] 09-03-PLAN.md — Profile cleanup: PostDetailModal edit/delete via API, ProfileFeed/MyProfileView/ProfileView type rewire, delete postService
- [x] 09-04-PLAN.md — UAT gap closure: fix upload purpose string, Post @Version null initialization, seed SQL version column
- [ ] 09-05-PLAN.md — UAT gap closure: fix FK constraint violation on post delete by cascade-deleting children and removing @ManyToOne FKs
- [ ] 09-06-PLAN.md — UAT gap closure: add three-dot dropdown menu with edit/delete options in FeedItem and PostDetailModal
- [ ] 09-07-PLAN.md — UAT gap closure: wire inline post edit in FeedItem dropdown, verify PostDetailModal edit flow
...
| 11. Dashboard | 4/4 | Complete    | 2026-03-08 |
