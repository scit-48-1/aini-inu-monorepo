...
export const DashboardHero: React.FC<DashboardHeroProps> = ({ userProfile, mainDog, grassData, totalWalks }) => {
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <div className="px-6 py-4 bg-amber-50/50 rounded-[24px] border border-amber-100 flex items-center gap-3">
                ...
                <div>
                  ...
                  <Typography variant="h3" className="text-navy-900 text-xl">{userProfile.mannerScore}/10</Typography>
                </div>
              </div>
